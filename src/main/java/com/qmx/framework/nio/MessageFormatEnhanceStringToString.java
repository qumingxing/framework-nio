 ...
 * 
 */
public class MessageFormatEnhanceStringToString implements
		EnhanceMessageFormatToString
{
	 ...
	 * 
	 */
	public MessageFormatEnhanceStringToString()
	{
	 ...
	 *            {@link TransferType}
	 */
	public MessageFormatEnhanceStringToString(TransferType transferType)
	{
	...
	public byte[] format(TransferType transferType, byte[] bytes)
	{
		...
		{
			lengthArr = (String.valueOf(ASYNCHRONY + "S"

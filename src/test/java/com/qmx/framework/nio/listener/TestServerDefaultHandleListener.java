 ...
 * 
 */
public class TestServerDefaultHandleListener implements HandleListener
{
	private List<String> testData = new ArrayList<String>();
	private final Logger log = LoggerFactory
			.getLogger(TestServerDefaultHandleListener.class);
	public TestServerDefaultHandleListener()
	{
		for (int i = 0; i < 500; i++)
		{

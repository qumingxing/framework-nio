 ...
 * 
 */
public class TestServerDelimiterDefaultHandleListener implements HandleListener
{
	private List<String> testData = new ArrayList<String>();
	private final Logger log = LoggerFactory
			.getLogger(TestServerDelimiterDefaultHandleListener.class);
	public TestServerDelimiterDefaultHandleListener()
	{
		for (int i = 0; i < 500; i++)
		{
